            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="box-title">Tambah Data Produk <small>{{ $item->name }} </small> </h4>
                    </div>

                    <div class="card-body">
                        <form class="col-12" method="POST" action="{{ route('products.update', $item->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    <label>Tipe Produk</label>
                                        <input type="text" class="form-control @error('type') is-invalid @enderror" id="type" placeholder="Masukan Tipe" name="type" 
                            ...
                            <div class="row">
                                <div class="col-md-3 form-group">
                                    <label>Harga</label>
                                        <input type="number" class="form-control @error('price') is-invalid @enderror" id="price" placeholder="Masukan Harga" name="price" 
                                ...
                                <div class="col-md-3 form-group">
                                    <label>Kuantitas</label>
                                        <input type="number" class="form-control @error('quantity') is-invalid @enderror" id="quantity" placeholder="Masukan Kuantitas" name="quantity" 
